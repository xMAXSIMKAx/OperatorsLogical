...
public class OperatorsLogical {
    ...
    public static void main(String[] args) {
        ...
        if (income <= 10000) {
            ...
            double netIncome = income - calculatedPercentage;
            System.out.println("\nyour net income is " + netIncome + "including tax 2.5%");

        } else if (income >= 10000 && income <= 25000) {
            double percentageLittle = 4.3;
            double calculatedPercentage = (income * percentageLittle) / 100;
            double netIncome = income - calculatedPercentage;
            System.out.println("\nyour net income is " + netIncome + " including tax 4.3%");

        } else if (income >= 25000) {
            double percentageLittle = 6.7;
            double calculatedPercentage = (income * percentageLittle) / 100;
            double netIncome = income - calculatedPercentage;
            System.out.println("\nyour net income is " + netIncome + " including tax 6.7%");
